...
<body>
    <div class="Search_Options" style="position:sticky;top:0;"data-aos="zoom-in-up">
        <div>
            ...
            <div class="loc" >
                ...
                <div class="loccon"   id="thuonghieu">
                    ...
                    <div class="hangxe_kien">
                        <div>
                            <form action="/preOwned_car.php" method="POST">
            ...
            <div class="reset">
                <a style="font-size:15px;color:#2c9f1c;font-size:small;" class="Reset" href="/preOwned_car.php" ><i style=" color:#2c9f1c;margin:2px;" class="bi bi-arrow-counterclockwise"></i>RESET ALL</a>
            </div>
       </div>
    </div>
